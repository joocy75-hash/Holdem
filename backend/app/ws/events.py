...
class EventType(str, Enum):
    ...
    # Tournament events (10)
    TOURNAMENT_SUBSCRIBE = "TOURNAMENT_SUBSCRIBE"
    TOURNAMENT_UNSUBSCRIBE = "TOURNAMENT_UNSUBSCRIBE"
    TOURNAMENT_STATE = "TOURNAMENT_STATE"
    TOURNAMENT_BLIND_CHANGE = "TOURNAMENT_BLIND_CHANGE"
    TOURNAMENT_BLIND_WARNING = "TOURNAMENT_BLIND_WARNING"
    TOURNAMENT_RANKING_UPDATE = "TOURNAMENT_RANKING_UPDATE"
    TOURNAMENT_PLAYER_ELIMINATED = "TOURNAMENT_PLAYER_ELIMINATED"
    TOURNAMENT_PLAYER_MOVED = "TOURNAMENT_PLAYER_MOVED"
    TOURNAMENT_SHOTGUN_COUNTDOWN = "TOURNAMENT_SHOTGUN_COUNTDOWN"
...
CLIENT_TO_SERVER_EVENTS = frozenset([
    ...
    # Tournament events
    EventType.TOURNAMENT_SUBSCRIBE,  # 토너먼트 구독
    EventType.TOURNAMENT_UNSUBSCRIBE,  # 토너먼트 구독 해제
])
...
SERVER_TO_CLIENT_EVENTS = frozenset([
    ...
    # Tournament events
    EventType.TOURNAMENT_STATE,
    EventType.TOURNAMENT_BLIND_CHANGE,
    EventType.TOURNAMENT_BLIND_WARNING,
    EventType.TOURNAMENT_RANKING_UPDATE,
    EventType.TOURNAMENT_PLAYER_ELIMINATED,
    EventType.TOURNAMENT_PLAYER_MOVED,
    EventType.TOURNAMENT_SHOTGUN_COUNTDOWN,
