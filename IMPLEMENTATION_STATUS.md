...
> 마지막 업데이트: 2026-01-18 (9개 기능 구현 완료 - 완료율 96%)
...
- [x] JWT 토큰 관리
- [x] bcrypt 비밀번호 해싱
- [x] 성인 인증 / KYC 모듈 ✅ (2026-01-18)
- [x] 파일: `backend/app/services/auth.py`, `backend/app/services/kyc.py`

### 프로필 및 전적 관리
- [x] 닉네임 설정
- [x] 아바타 설정 ✅ (2026-01-18)
- [x] 통계 지표 (VPIP, PFR, 3Bet, AF, WTSD, WSD 등) ✅ (2026-01-18)
- [x] 기본 전적 데이터
...
- [x] 관전자 핸드 카드 정보 제한
- [x] 중간 입장 시 테이블 상황 동기화 (Snapshot)
- [x] 파일: `backend/app/engine/state.py`

### 채팅 및 이모티콘
- [x] 전체 채팅
- [x] 플레이어 전용 채팅 구분 ✅ (2026-01-18)
- [x] 이모티콘 시스템 (20종) ✅ (2026-01-18)
- [x] 파일: `backend/app/ws/handlers/chat.py`, `backend/app/services/emoticon.py`

### 핸드 히스토리
- [x] 핸드 기록 저장
- [x] 핸드 요약 정보
- [x] 리플레이(Replay) 기능 ✅ (2026-01-18)
- [x] 파일: `backend/app/models/hand.py`, `backend/app/api/hands.py`
...
- [x] 승리/패배 연출
- [x] 진동/사운드 피드백 ✅ (2026-01-18)
- [x] Big Win 이펙트 ✅ (2026-01-18)
...
### 높음 (High Priority)
- [x] Backoffice 대시보드 기본 구현
- [x] 부정 행위 탐지 시스템 (Anti-Collusion)
- [x] 봇(Bot) 탐지 시스템
